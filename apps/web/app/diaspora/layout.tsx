...
const navItems = [
  ...
  { href: "/diaspora/paiements", label: "Paiements", icon: "💰" },
  { href: "/diaspora/messages", label: "Messages", icon: "💬" },
  { href: "/diaspora/documents", label: "Documents", icon: "📄" },
      ...
      <header className="border-b border-border bg-white">
        <div className="mx-auto flex w-full max-w-[1320px] items-center justify-between gap-3 px-4 py-2.5">
          <div className="flex items-center gap-2.5">
            <div className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-blue to-blue-mid text-white">🏠</div>
          ...
          return (
            <Link
              ...
              className={`flex flex-1 flex-col items-center gap-0.5 py-2.5 no-underline transition-colors ${
                isActive ? "text-blue" : "text-textMuted"
              }`}
            >
